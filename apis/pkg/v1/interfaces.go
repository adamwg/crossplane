...
type PackageWithExternalRevisions interface {
	...
	GetExternalRevisions() []corev1.LocalObjectReference
	SetExternalRevisions(revs []corev1.LocalObjectReference)
}
...
// GetExternalRevisions of this Function.
func (f *Function) GetExternalRevisions() []corev1.LocalObjectReference {
	return f.Spec.ExternalRevisions
}

// SetExternalRevisions of this Function.
func (f *Function) SetExternalRevisions(revs []corev1.LocalObjectReference) {
	f.Spec.ExternalRevisions = revs
}
