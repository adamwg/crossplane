...
type FunctionSpec struct {
	...
	// ExternalRevisions are FunctionRevisions that are managed externally,
	// rather than by the package manager. When spec.package is empty and
	// external revisions exist, the package manager propagates the status of
	// these external revisions to the Function.
	// +optional
	// +listType=map
	// +listMapKey=name
	ExternalRevisions []corev1.LocalObjectReference `json:"externalRevisions,omitempty"`
}
