...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InputBlob) DeepCopyInto(out *InputBlob) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InputBlob.
func (in *InputBlob) DeepCopy() *InputBlob {
	if in == nil {
		return nil
	}
	out := new(InputBlob)
...
func (in *PipelineStep) DeepCopyInto(out *PipelineStep) {
	*out = *in
	...
	if in.InputBlob != nil {
		in, out := &in.InputBlob, &out.InputBlob
		*out = new(InputBlob)
		(*in).DeepCopyInto(*out)
	}
