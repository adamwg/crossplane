...
import (
	...
	"github.com/crossplane/crossplane/v2/internal/project/controlplane"
...
func (c *stopCmd) Run(_ *kong.Context, logger logging.Logger) error {
	...
	if name == "" {
		...
		prj, err := project.Parse(projFS, projFileName)
		if err != nil {
