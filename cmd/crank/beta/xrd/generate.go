...
import (
	...
	"github.com/crossplane/crossplane/v2/internal/xrd"
)
...
type generateCmd struct {
	...
	From        string `help:"Input format: xr or simpleschema."      default:"xr" enum:"xr,simpleschema"`
...
func (c *generateCmd) Run(k *kong.Context) error {
	...
	default:
		xrdObj, err = newXRDv2(yamlData, c.Plural)
	}
	if err != nil {
...
func marshalXRD(obj any) ([]byte, error) {
	...
	// Remove nil creationTimestamp that k8s types always include.
...
func parseAndValidateXRD(yamlData []byte, customPlural string) (*parsedXRD, error) {
	...
	return &parsedXRD{
		...
		rawSchema:    &runtime.RawExtension{Raw: schemaBytes},
