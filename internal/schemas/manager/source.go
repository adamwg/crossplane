...
type gitSource struct {
	gitRef       *v1alpha1.APIGitReference
	cloner       git.Cloner
...
type httpSource struct {
	httpRef    *v1alpha1.APIHTTPReference
	client     *http.Client
	sourceType SourceType
	fs         afero.Fs
}
...
type k8sOpenAPISource struct {
	k8sRef     *v1alpha1.APIK8sReference
	client     *http.Client
	fs         afero.Fs
}
...
func NewK8sSource(dep v1alpha1.APIDependencies) Source {
...
// MarshalYAML marshals the given object to YAML bytes.
