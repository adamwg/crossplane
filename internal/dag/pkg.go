...
// package may be installed at once (for example several active function
// revisions during a progressive rollout), in which case a single PackageNode
// represents all of them: the embedded LockPackage holds the representative
// (first seen) version. versions holds all installed versions and dependencies
// holds the union of all installed versions' dependencies.
