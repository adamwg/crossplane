...
func TestFormatKclImportPath(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"AliasConflict": {
			path:            "kcl/io/upbound/platformref/aws/v1alpha1",
			existingAliases: map[string]bool{"awsv1alpha1": true},
			wantImport:      "models.io.upbound.platformref.aws.v1alpha1",
		...
		"TopLevelPath": {
			path:            "kcl/io.upbound.aws.v1alpha1",
			existingAliases: map[string]bool{},
			wantImport:      "models.io.upbound.aws.v1alpha1",
