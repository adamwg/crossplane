...
import (
	...
	pyaml "github.com/crossplane/crossplane/v2/internal/xpkg/parser/yaml"
)
...
func (b *realBuilder) Build(ctx context.Context, project *devv1alpha1.Project, projectFS afero.Fs, opts ...BuildOption) (ImageTagMap, error) { //nolint:gocyclo // This is the main build orchestration.
	...
	if b.schemaManager != nil {
		...
		if _, err := b.schemaManager.Generate(ctx, manager.NewFSSource(apisSource)); err != nil {
	...
	imgMap, deps, err := b.buildFunctions(ctx, functionsSource, project, o.projectBasePath, o.eventCh)
	if err != nil {
		return nil, err
	}
...
func (b *realBuilder) buildFunctions(ctx context.Context, fromFS afero.Fs, project *devv1alpha1.Project, basePath string, eventCh async.EventChannel) (ImageTagMap, []xpmetav1.Dependency, error) {
	var (
...
// given filesystem.
func (b *realBuilder) buildFunction(ctx context.Context, fromFS afero.Fs, project *devv1alpha1.Project, fnName string, basePath string) ([]v1.Image, error) {
