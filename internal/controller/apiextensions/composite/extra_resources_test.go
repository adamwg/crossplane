...
func TestFetchingFunctionRunner(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"RunFunctionError": {
			...
			params: params{
				wrapped: FunctionRunnerFn(func(_ context.Context, _ *v1.FunctionReference, _ *fnv1.RunFunctionRequest) (*fnv1.RunFunctionResponse, error) {
		...
		"Success": {
			...
			params: params{
				wrapped: FunctionRunnerFn(func(_ context.Context, _ *v1.FunctionReference, req *fnv1.RunFunctionRequest) (*fnv1.RunFunctionResponse, error) {
