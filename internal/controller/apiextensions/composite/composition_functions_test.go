...
func TestFunctionCompose(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"RunFunctionError": {
			...
			params: params{
				r: FunctionRunnerFn(func(_ context.Context, _ *v1.FunctionReference, _ *fnv1.RunFunctionRequest) (rsp *fnv1.RunFunctionResponse, err error) {
					return nil, errBoom
				}),
				o: []FunctionComposerOption{
					WithCompositeConnectionDetailsFetcher(ConnectionDetailsFetcherFn(func(_ context.Context, _ resource.ConnectionSecretOwner) (managed.ConnectionDetails, error) {
		...
		"Successful": {
			...
			params: params{
				...
				r: FunctionRunnerFn(func(_ context.Context, _ *v1.FunctionReference, _ *fnv1.RunFunctionRequest) (*fnv1.RunFunctionResponse, error) {
